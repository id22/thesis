...
%Such an infrastructure is currently poorly developed in the Internet as discussed later. 
...
%Figure 1 illustrates these degrees of freedom.  Network routing refers to selecting the physical path between pairs of nodes in the network.
